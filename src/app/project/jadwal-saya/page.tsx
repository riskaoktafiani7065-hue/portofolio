...
export default function JadwalSayaProject() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-gray-500 dark:text-gray-400">
            A schedule management application designed to help users organize
            their activities and manage their time more systematically.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-[#111217]">
            ...
            <p className="mt-3 leading-7 text-gray-500 dark:text-gray-400">
              This project focuses on creating a simple and intuitive
              interface for managing daily schedules, activities, and tasks.
            </p>
          </div>
